    ...
    <div className="flex h-screen">
      ...
      <div className="flex-1 flex items-center justify-center bg-gray-50 px-6">
        <div className="w-full max-w-sm">
          <MobileLogo />
          <h2 className="font-display text-xl font-semibold text-slate-900 mb-1">Create account</h2>
          <p className="text-sm text-slate-500 mb-6">Start ranking your site organically</p>
